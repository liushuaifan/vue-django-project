<template>
  ...
  <!-- <div style="text-align: center; font-size: 30px;">       -->
      ...
      >
      <VCard 
        router-link :to="'/DiningReview/' +  review.id"
        class="pa-3"
      >
      <v-container>
        <v-row no-gutters>
          <v-col>
            ...
            <p class="text-left" align-self="center">Dining Hall: {{review.dining_hall_name}}</p>
          </v-col>

          <v-col align-self="center">
            <p class="text-center text-subtitle-1 font-weight-regular">Dining Hall Rating</p>
            <v-rating
              class="pa-2 ma-2"
...
export default{
    ...
    methods: {
          ...
          try {
              ...
              if (!this.query){
                if(localStorage.getItem('schoolID')){
                  temp = `http://18.191.156.68:8000/api/dining/reviews/?school=` + localStorage.getItem('schoolID');
                } else {
                ...
                if(localStorage.getItem('schoolID')){
                  temp = `http://18.191.156.68:8000/api/dining/reviews/?school=` + localStorage.getItem('schoolID') + '&dining_halls=' + dining_halls;
                } else {
                  temp = 'http://18.191.156.68:8000/api/dining/reviews/?dining_halls=' + dining_halls;
                }
              ...
              this.reviews.forEach(review => {
                ...
                this.searchscoreTaste += review["taste"];
                this.searchscoreVariety += review["variety"];
              ...
              if(this.reviews.length > 0) {
                ...
                this.searchscoreTaste = Math.trunc(this.searchscoreTaste * 10/this.reviews.length) / 10;
                this.searchscoreVariety = Math.trunc(this.searchscoreVariety * 10/this.reviews.length) / 10;
              }
      ...
      created() {
        ...
        this.query = JSON.parse(localStorage.getItem('diningSearchQuery'));
        document.title = "Dining Hall Reviews";
